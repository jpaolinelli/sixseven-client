...
- Write the TypeScript/React code, the tests, and ensure everything passes quality gates before delivering.
...
- You do not write QA regression tests (`qa-*.test.ts`). QA tests are owned by the QA process.
...
- **quality-checks** — TypeScript type checking, build, test commands.
- **git-workflow** — Branching, commit message format, PR creation.
- **sixseven-conventions** — TypeScript/React coding standards.
- **sixseven-testing** — Vitest test patterns and assertion conventions.
- **sixseven-architecture** — Understanding the component structure and data flow.
