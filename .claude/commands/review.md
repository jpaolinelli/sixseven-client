...
- Read every source file (components, utilities, API routes, tests) completely.
- Run the full quality suite: type check, build, tests, lint.
...
2. **Find and read all source files** → Every component, utility, API route, and test file.
3. **Run quality checks** → Type check, build, tests, lint.
4. **Cross-check criteria** → Map every criterion to ✅ / ⚠️ / ❌ with evidence.
5. **Evaluate quality** → Code correctness, test quality, React patterns, TypeScript usage.
...
- **quality-checks** — How to run type check, build, tests, lint.
- **sixseven-conventions** — TypeScript/React coding standards to check against.
- **sixseven-testing** — Test quality requirements to evaluate against.
- **sixseven-architecture** — Understanding the component structure for architectural assessment.
